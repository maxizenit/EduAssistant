...
public abstract class AbstractControllerHttpClient {
    ...
    public AbstractControllerHttpClient(RestTemplate restTemplate, String serviceUri) {
        this.restTemplate = restTemplate;
        this.serviceUri = serviceUri;
    }

    private String createUri(String path, Collection<String> paramKeys) {
        UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(String.format("%s%s", serviceUri, path));
    ...
    protected final void delete(
            ...
            Map<String, ?> uriVariables,
            Object requestBody) {
        exchange(path, HttpMethod.DELETE, requestBody, Void.class,  uriVariables);
    }
}
