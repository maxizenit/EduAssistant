...
import ru.itmo.eduassistant.bot.service.state.teacher.TeacherInQueueMenuState
    ...
    fun handleCallbackQuery(callbackQuery: CallbackQuery): BotApiMethod<*> {
        ...
        return stateSwitcher.switchStateFromCallback(
            callbackQuery, when (callbackType) {
                ...
                CallbackType.TEACHER_IN_QUEUE_MENU_STATE_QUEUE_CHOICE -> TeacherInQueueMenuState::class
